...
hf=28;
figure(28); clf(28)
set(gcf, 'unit', 'centimeters', 'position', [2 2 25 25], 'paperpositionmode', 'auto' ,'color', 'w')
...
% Cued
axes('unit', 'centimeters', 'position', [1.5 ylevel_cue Width 3], 'nextplot', 'add', 'xlim', tRange,...
...
% Combined
axes('unit', 'centimeters', 'position', [1.5 ylevel_both Width 3], 'nextplot', 'add', 'xlim', tRange,...
    'ylim', [0.5 NCells+0.5], 'ydir', 'reverse', 'ticklength', [0.025 0.01], 'XTickLabelRotation', 35);
...
% copy the png file to another folder
