...
function makeWhiskerVm_movieNewP(iwdata2, whiskervid, trialnum, w, Vth, poleonoff, yrange, name, poleposition, wid, plotlick, ex, title)
...
text(210+start*1000, yrange(2, 1)+8, '500ms', 'fontsize', 10)
line([-50+start*1000 -50+start*1000],[-40 0], 'color', 'k', 'linewidth', 2)
text(-175+start*1000, -20, '20deg', 'fontsize', 10)
