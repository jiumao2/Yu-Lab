...
# path = [r'D:\Ephys\DLC\Chen_Davis_topview-HY-2022-05-25\labeled-data',
#         r'D:\Ephys\DLC\Eli_TopView-HY-2022-01-18\labeled-data',
#         r'D:\Ephys\DLC\Eva2_topwiew-HY-2022-03-24\labeled-data',
#         r'D:\Ephys\DLC\Russo_TopView-HY-2022-01-12\labeled-data',
#         r'D:\Ephys\DLC\Urey_top_view-HY-2021-12-31\labeled-data']
...
#                             df.loc['labeled-data\\All\\'+ '%.6d' % count +'.png'] = [df_temp['HY','right_ear','x'],df_temp['HY','right_ear','y']]
#                             break                   
...
path = [r'D:\Ephys\ANMs\Chen\Video',r'D:\Ephys\ANMs\Davis\Video',r'D:\Ephys\ANMs\Eli\Sessions',r'D:\Ephys\ANMs\Russo\Sessions',r'D:\Ephys\ANMs\Urey\Videos',r'D:\Ephys\ANMs\Eva-2\Sessions']
count = 0
for each in path:
    for dir_name in os.listdir(each):
        if len(dir_name)>8 and dir_name[-6:] == '_video':
            dir_this = os.path.join(each,dir_name,'VideoFrames_top/ModifiedFrames/')
