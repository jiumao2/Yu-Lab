function PlotSingleOptoPerformance(bmix, manipulation)
...
hf19 = figure(19); clf,
set(gcf, 'name', 'OptoStimMix', 'units', 'centimeters', 'position', [25 5 34 19], 'paperpositionmode', 'auto');
...
%% plot press duration
ha7 = axes('units', 'centimeters', 'position', [15 8 5 4], 'nextplot', 'add','xlim', [0 5], 'ylim', [0 3000],'yscale', 'linear','ytick', [0:500:3000], 'xtick', [1 2 3 4], 'xticklabel', {'Control','App', 'Press', 'Trigger'});
% plot short

plotshaded([0.5 4.5], [750 750; 750+600 750+600],[175 255 175]/255)
...
% density
ha7ksd = axes('units', 'centimeters', 'position', [20.5 8 2.5 4], 'nextplot', 'add','xlim', [0 3000], 'ylim', [0 0.25],'xtick', [0:1000:3000], 'xticklabel', {'0', '1', '2', '3'},'ytick', [0:0.25:1]);
timebins = [0:50:3000];
plotshaded([750 750+600 ], [0 0; 1 1], [175 255 175]/255)
...
ha8 = axes('units', 'centimeters', 'position', [24.5 8 5 4], 'nextplot', 'add','xlim', [0 4.5], 'ylim', [0 3000],'yscale', 'linear','ytick', [0:500:3000], 'xtick', [1 2], 'xticklabel', {'Control', 'App', 'Press', 'Trigger'});
% plot long
plotshaded([0.5 4.5], [1500 1500; 1500+600 1500+600],[175 255 175]/255)
...
% 
% density
ha8ksd = axes('units', 'centimeters', 'position', [30 8 2.5 4], 'nextplot', 'add','xlim', [0 3000], 'ylim', [0 0.25],'xtick', [0:1000:3000], 'xticklabel', {'0', '1', '2', '3'},'ytick', [0:0.25:1]);
timebins = [0:50:3000];
plotshaded([1500 1500+600 ], [0 0; 1 1], [175 255 175]/255)
...
savename = ['OptoMixed_' Dataout.ANM];
