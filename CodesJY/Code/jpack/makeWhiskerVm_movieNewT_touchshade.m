...
function makeWhiskerVm_movieNewT_touchshade(iwdata2, whiskervid, trialnum, w, Vth,  yrange, name,wid, plotlick, ex, title)
% makeWhiskerVm_movieNew(iwdata2, tvidFrames.t177, 178, w, -47.9, [0.8325 2.8340], [-85 20; -40 40], 'JY0861touch')
% 12.27.2017 touch as shades
...
text(170+start*1000, yrange(2, 1)+8, '500ms', 'fontsize', 12)
line([-50+start*1000 -50+start*1000],[-40 0], 'color', 'k', 'linewidth', 2)
text(-245+start*1000, -20, '20deg', 'fontsize', 12)
