...
ax_raster_trigger1_1.YTick = [1,ntrial_raster];
ax_raster_trigger1_1.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger1_2.YTick = [1,ntrial_raster];
ax_raster_trigger1_2.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger2_1.YTick = [1,ntrial_raster];
ax_raster_trigger2_1.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger2_2.YTick = [1,ntrial_raster];
ax_raster_trigger2_2.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger3_1.YTick = [1,ntrial_raster];
ax_raster_trigger3_1.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger3_2.YTick = [1,ntrial_raster];
ax_raster_trigger3_2.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger4_1.YTick = [1,ntrial_raster];
ax_raster_trigger4_1.YLim = [0.5,ntrial_raster+0.5];
...
ax_raster_trigger4_2.YTick = [1,ntrial_raster];
ax_raster_trigger4_2.YLim = [0.5,ntrial_raster+0.5];
...
function make_plot(data_path_trigger1,ax_raster_trigger1_1,ax_raster_trigger1_2,ax_PETH_trigger1)
global colors_name color_press color_release color_trigger linewidth_event linewidth_PSTH t_pre t_post binwidth_PSTH ntrial_raster
load(data_path_trigger1{1})
unit_num = data_path_trigger1{2};
...
for k = 1:length(rnd)
    ...
    plot(ax_raster_trigger1_1,[t_release_this-1500,t_release_this-1500],[-0.5+k,0.5+k],'-','Color',color_release,'LineWidth',linewidth_event);
...
for k = 1:length(rnd)
    ...
    plot(ax_raster_trigger1_2,[t_release_this-750,t_release_this-750],[-0.5+k,0.5+k],'-','Color',color_release,'LineWidth',linewidth_event);
