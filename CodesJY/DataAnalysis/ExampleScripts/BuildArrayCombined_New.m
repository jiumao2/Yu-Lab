...
blocks                                             = { '002', '003'}; % these are different sessions
...
for ib=1:length(blocks)
    ...
    EventOut = DIO_Events2(NEV) % create
...
r.Behavior.Labels={'TBD1', 'TBD2', 'LeverPress', 'Trigger', 'LeverRelease', 'GoodPress', 'GoodRelease',...
...
allcolors                                          = varycolor(size(units, 1));
