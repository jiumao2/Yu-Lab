...
% Jianing Yu Nov 16 2019 bpod is involved. reward delivery is through bpod
...
text(2.5, 4, strrep(bout.Metadata.ProtocolName, '_', '-'))
text(2.5, 3, upper(bout.Metadata.SubjectName))
text(2.5, 2, bout.Metadata.Date)
text(2.5, 1, bout.Metadata.StartTime)


bout.SessionName     =      session_name;
bout.PressTime       =      time_leverpress';
bout.ReleaseTime     =      time_leverrelease';
% bout.PressDur        =      time_leverrelease'-time_leverpress';
