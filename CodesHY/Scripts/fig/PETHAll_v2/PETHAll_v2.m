...
%% sort by min
[~,max_idx_long] = min(smoothdata(average_spikes_long_all,'gaussian',1));
[~,sort_idx_long] = sort(max_idx_long,'descend');
...
h_annotation = annotation(h,'textarrow',...
    ...
    'color','k',...
    'TextRotation',270);
set(h_annotation,'X',[margin_left+width_PSTH+width_colorbar+1,margin_left+width_PSTH+width_colorbar+1],'Y',[2.75, 2.75])
%% Save Figure
