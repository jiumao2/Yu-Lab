...
if size(r.Units.SpikeNotes, 2) == 4
    ...
    uicontrol('style', 'text', 'units', 'centimeters', 'position', [1 yshift_row4 6 1.2],...
...
if isfield(r, 'BehaviorClass')
uicontrol('style', 'text', 'units', 'centimeters', 'position', [1 yshift_row4+1.2 6 0.5],...
    'string', ([anm_brain ' '  r.BehaviorClass.Date]), 'BackgroundColor','w',...
    'fontsize', 10, 'fontweight', 'bold',  'FontName','Dejavu Sans')
else
   uicontrol('style', 'text', 'units', 'centimeters', 'position', [1 yshift_row4+1.2 6 0.5],...
    'string', ([anm_brain ' '  strrep( r.Meta(1).DateTime(1:11), '-', '_')]), 'BackgroundColor','w',...
    'fontsize', 10, 'fontweight', 'bold',  'FontName','Dejavu Sans') 
end
