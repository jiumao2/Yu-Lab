...
function makeWhisker_movieNewP_touchshade(iwdata2, whiskervid, trialnum, w, Vth, poleonoff, yrange, name, poleposition, wid, plotlick, ex, title)
...
text(start*1000, 10, 'Whisker position', 'fontsize', 12, 'color',[0 208 0]/255)
