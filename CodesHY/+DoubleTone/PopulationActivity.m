...
if ~isfield(r, 'PSTH')
    error('Compute PSTH first. Run " >>DoubleTone.DoubleToneSpikes(r, []);" ')
end
...
[PopOut.IndSort, PopOut.IndUnmodulated] = DoubleTone.RankActivity(PopOut);

PopOut.IndSort = DoubleTone.VisualizePopPSTH(PopOut);
r.PopPSTH = PopOut;
