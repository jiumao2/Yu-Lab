function bUpdated =  GetOptoBehavePressStim(isession, ibpodsession)
% Jianing Yu 
% 7/10/2021
...
for j =1 : length(sd.RawEvents.Trial)
    ...
    if  isfield(sd.RawEvents.Trial{j}.States, 'WaitForPressStim') && ~isnan(sd.RawEvents.Trial{j}.States.WaitForPressStim(1))  % if this state exists, it is a stim trial following approach
    ...
    elseif  isfield(sd.RawEvents.Trial{j}.States, 'WaitForTriggerStim') &&~isnan(sd.RawEvents.Trial{j}.States.WaitForTriggerStim(1))  % if this state exists, it is a stim trial following press
    ...
    elseif   isfield(sd.RawEvents.Trial{j}.States, 'WaitForMedTTLStim') && ~isnan(sd.RawEvents.Trial{j}.States.WaitForMedTTLStim(1))  % if this state exists, it is a stim trial following trigger signal
    ...
    elseif  isfield(sd.RawEvents.Trial{j}.States, 'ReleaseStim') &&  ~isnan(sd.RawEvents.Trial{j}.States.ReleaseStim(1))  % if this state exists, it is a stim trial following release
    ...
    if ~isnan(sd.RawEvents.Trial{j}.States.WaitForPress(1)) || ~isnan(sd.RawEvents.Trial{j}.States.WaitForPressStim(1))
        ...
        elseif ~isnan(sd.RawEvents.Trial{j}.States.WaitForPressStim(1)) && sd.RawEvents.Trial{j}.States.WaitForPressStim(1, 2) == sd.RawEvents.Trial{j}.States.WaitForTrigger(1, 1)
