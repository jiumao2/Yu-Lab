...
vid_side = VideoReader('D:\Ephys\ANMs\Davis\Video\20220331_video\VideoFrames_side\RawVideo\Press056.avi');
bg_side_traj1 = vid_side.read(-r.VideoInfos_top(1).t_pre/10);
vid_side = VideoReader('D:\Ephys\ANMs\Davis\Video\20220331_video\VideoFrames_side\RawVideo\Press055.avi');
bg_side_traj2 = vid_side.read(-r.VideoInfos_top(1).t_pre/10);
