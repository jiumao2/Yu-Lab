...
haspkwaveover = axes('unit', 'centimeters', 'position', [.5, 0.5, 3 6.5], 'nextplot', 'add', 'ylim', vrange1); axis off

for k =1:nclusters-1
    haspkwave(k) = axes('unit', 'centimeters', 'position', [.5, 3+1.9*(k-1), 3 6.5], 'nextplot', 'add', 'ylim', vrange1); axis off
