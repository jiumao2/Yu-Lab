function Indout = findseqmatch2(seqmom, seqson,varargin)
...
%  indout = findseqmatch2(seqmom, seqson, 'manual', 1, 'threshold', th, 'toprint', 1, 'printname', 'NewData')
...
for i =1:length(seqson)
    ...
    basecorr(i) = th*std(corr_momson(setdiff([1:length(corr_momson)], indmax)));
...
if toprint
    print (gcf,'-dpng', ['Alignment' printname]);
end;
