classdef KornblumClass  
    ...
    methods
        function obj = KornblumClass(medfile)
            ...
            bdata = track_training_progress_advanced_KornblumStyle(medfile);
            % b2 = BehaviorClass(b);
...
%             end
        ...
        function value=get.PerformanceSlidingWindow(obj)
            ...
            WinSize = min(30, floor(obj.TrialNum/5));
            StepSize = min(5, max(1, floor(WinSize/5)));
            CountStart = 1;
            WinPos = [];
            CorrectRatio=[];
            PrematureRatio=[];
            ...
            value = table(TrialIndex', WinPos', CorrectRatio(:, 2), CorrectRatio(:, 1), PrematureRatio(:, 2), PrematureRatio(:, 1), ...
                ...
                'Premature_Uncued', 'Late_Uncued', 'Late_Cued'});
        end;
        ...
        function value = get.Stage(obj)
         ...
         function value = get.HoldTimeDistribution(obj)
             binEdges = [0:0.05:2+obj.MixedFP/1000];
             binCenters = (binEdges(1:end-1)+binEdges(2:end))/2;

             % Cued
             CuedHT = obj.HoldTime(obj.Cue == 1 & (strcmp(obj.Outcome, 'Correct')|strcmp(obj.Outcome, 'Premature')|strcmp(obj.Outcome, 'Late')));
             [data2575] = prctile(CuedHT, [25, 75]);
             interq = data2575(2) - data2575(1);
             c=5;
             CuedHT(CuedHT>data2575(2)+interq*c | CuedHT<data2575(1)-interq*c) = [];
             PDF_Cued = histcounts(CuedHT, binEdges, 'Normalization','pdf');
             CDF_Cued = histcounts(CuedHT, binEdges, 'Normalization','cdf');
             ...
             [data2575] = prctile(UncuedHT, [25, 75]);
             interq = data2575(2) - data2575(1);
             c=5;
             UncuedHT(UncuedHT>data2575(2)+interq*c | UncuedHT<data2575(1)-interq*c) = [];
             PDF_Uncued = histcounts(UncuedHT, binEdges, 'Normalization','pdf');
             CDF_Uncued = histcounts(UncuedHT, binEdges, 'Normalization','cdf');
        ...
        function plot(obj)
            ...
            hui_1 = uicontrol('Style', 'text', 'parent', 20, 'units', 'normalized', 'position', [0.1 0.945 0.2 0.05],...
                'string', [obj.Subject], 'fontweight', 'bold', ...
                'backgroundcolor', [1 1 1], 'HorizontalAlignment', 'left' );

            hui_2 = uicontrol('Style', 'text', 'parent', 20, 'units', 'normalized', 'position', [0.2 0.945 0.3 0.05],...
                'string', [obj.Session], 'fontweight', 'bold', ...
                'backgroundcolor', [1 1 1], 'HorizontalAlignment', 'left' );

            hui_3 = uicontrol('Style', 'text', 'parent', 20, 'units', 'normalized', 'position', [0.4 0.945 0.2 0.05],...
            ...
            UncueColor    =          [255 178 0]/255;
            plot(obj.RTDistributionLoose.BinCenters, smoothdata(obj.RTDistributionLoose.PDF_Cued, 'gaussian', 7), 'color', CueColor, 'linewidth', 1)
            plot(obj.RTDistributionLoose.BinCenters, smoothdata(obj.RTDistributionLoose.PDF_Uncued, 'gaussian', 7), 'color', UncueColor, 'linewidth', 1)
            axis 'auto y'
            ...
            set(ha5b,'units', 'centimeters', 'position', [xlevel3, ylevel2, plotsize4], 'nextplot', 'add', ...
                ...
                'xlim', [0 2], ...
                'xticklabelrotation', 0, 'ticklength',[0.02 0.01]);
            plot(obj.RTDistributionLoose.BinCenters, smoothdata(obj.RTDistributionLoose.CDF_Cued, 'gaussian', 7), ...
                'color', CueColor, 'linewidth', 1)
            plot(obj.RTDistributionLoose.BinCenters, smoothdata(obj.RTDistributionLoose.CDF_Uncued, 'gaussian', 7), ...
            ...
            set(ha6,'units', 'centimeters', 'position', [xlevel4, ylevel, plotsize4], 'nextplot', 'add', ...
                ...
                'xlim', [0 3], ...
                'xticklabelrotation', 0, 'ticklength',[0.02 0.01]);
            plot(obj.HoldTimeDistribution.BinCenters, smoothdata(obj.HoldTimeDistribution.PDF_Cued, 'gaussian', 7), 'color', CueColor, 'linewidth', 1)
            plot(obj.HoldTimeDistribution.BinCenters, smoothdata(obj.HoldTimeDistribution.PDF_Uncued, 'gaussian', 7), 'color', UncueColor, 'linewidth', 1)
            ...
            set(ha6b,'units', 'centimeters', 'position', [xlevel4, ylevel2, plotsize4], 'nextplot', 'add', ...
                ...
                'xlim', [0 3], ...
                'xticklabelrotation', 0, 'ticklength',[0.02 0.01]);
            plot(obj.HoldTimeDistribution.BinCenters, smoothdata(obj.HoldTimeDistribution.CDF_Cued, 'gaussian', 7), ...
                'color', CueColor, 'linewidth', 1)
            plot(obj.HoldTimeDistribution.BinCenters, smoothdata(obj.HoldTimeDistribution.CDF_Uncued, 'gaussian', 7), ...
                'color', UncueColor, 'linewidth', 1)
            axis 'auto y'
