...
par.max_spikes_plot = 15000;          % max. number of spikes to be plotted 
par.print2file = true;               % If is not true, print the figure (only for batch scripts). 
par.cont_plot_samples = 10000;      % number of samples used in the one-minute (maximum) sample of continuous data to plot. 
...
par.min_clus = 500;                   % minimum size of a cluster (default 20) 
par.max_clus = 8;                   % maximum number of clusters allowed (default 200) 
...
par.template_k = 20;                % # of nearest neighbors 
par.template_k_min = 30;            % min # of nn for vote 
