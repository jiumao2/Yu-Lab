function PSTHOut = SpikesPSTHWithPassive(r, ind, varargin)
...
passive_event_fields = {'ToneTimesPassive', 'FlashTimesPassive'};
passive_event_labels = {'PassiveTone', 'PassiveFlash'};
for i_event = 1:numel(passive_event_fields)
    ...
    t_passive_events = sort(t_passive_events);
...
for iku =1:length(ku_all)
    ...
    PSTHOut.PSTH(iku)       = Spikes.AutoShaping.ComputePlotPSTHWithPassive(r, PSTHOut, ku,...
...
if takeall
    ...
    save(r_name, 'r', '-v7.3');
    psth_new_name             =      [Subject, '_', SessionInfo, '_PSTHsWithPassive.mat'];
