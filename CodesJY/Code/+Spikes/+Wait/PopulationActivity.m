...
nFP = length(r.BehaviorClass.MixedFP)+1;
...
[PopOut.IndSort, PopOut.IndUnmodulated] = Spikes.Wait.RankActivityFlat(PopOut);

PopOut.IndSort = Spikes.Wait.VisualizePopPSTH(PopOut);
r.PopPSTH = PopOut;
