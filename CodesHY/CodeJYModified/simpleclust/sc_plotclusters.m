...
if features.highlight>0
    plot( features.data_scaled(features.featureselects(1),features.highlight),features.data_scaled(features.featureselects(2),features.highlight),'w.','MarkerSize',5);
    ...
    if features.plotgroup
        plot( features.data_scaled(features.featureselects(1),features.highlight_multiple),features.data_scaled(features.featureselects(2),features.highlight_multiple),'w.','MarkerSize',5,'color',[.6 .6 .6]);
    end;
end;
